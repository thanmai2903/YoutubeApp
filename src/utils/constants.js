export const GOOGLE_API_KEY = "AIzaSyA2GxLfi_Bq0YKuiPhYLSkdV8KRbiul4Lo";

export const OFFSET_LIVE_CHAT = 25;

export const YOUTUBE_VIDEO_API =
  "https://youtube.googleapis.com/youtube/v3/videos?part=snippet,contentDetails,statistics&chart=mostPopular&maxResults=20&regionCode=IN&key=" +
  GOOGLE_API_KEY;
...
export const YOUTUBE_SEARCH_RESULTS_API =
  ...
  "https://www.googleapis.com/youtube/v3/search?part=snippet&type=video&maxResults=8&key=" +
  GOOGLE_API_KEY +
  "&q=";
